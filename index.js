...
/////////////////
const BotName = 'REYZZ BOT'; 
const instagram = 'https://instagram.com/reyzhaa30'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@reyzhaa30')
